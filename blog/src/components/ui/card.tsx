...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-sm text-white shadow bg-[#404040] dark:bg-[#373737] dark:border-zinc-800 dark:text-zinc-50",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("text-sm text-green-600 dark:text-green-600", className)}
    {...props}
  />
))
